...
- **Commit e push ao fim**.

## Por que essas regras existem
O valor do vault está na **confiabilidade do grafo**: backlinks recíprocos evitam ilhas, `areas:` corretas alimentam os hubs Dataview, a proveniência torna tudo rastreável, e o commit e push são a âncora reversível. A pausa do passo 3 existe porque o operador conhece o domínio melhor que o agente e pode redirecionar antes do trabalho pesado.
