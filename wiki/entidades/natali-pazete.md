...
> **Resumo:** Atriz e dubladora do elenco fixo — voz de Any Malu, Betty Cooper (Riverdale) e Lily James (incl. Cinderela 2015).

## Função e papel
Atriz e dubladora.

## Trajetória / créditos
- **Dublagens:** Cinderela (live action), Destiny (*Procurando Dory*), Void (*Os Incríveis 2*), Betty Cooper (*Riverdale*), voz original de Any Malu (*O Surreal Mundo de Any Malu*).
- **Teatro:** *Subconsciente*, *Um Indivíduo Só*, *A Chorus Line*, *Vida de Inseto*.
- Formação: Cinema (Estácio de Sá), dublagem (Escola de Rádio), Tablado, CEAE. Idiomas: inglês avançado.
