---
title: "Fonte — Circulação Teatral"
type: fonte
...
> **Resumo:** Modelo de parceria com produtores locais, fluxo operacional de 8 etapas, modelo de turnês e gestão de riscos para levar espetáculos para fora do Rio.

## Metadados
- **Arquivo:** `raw/AL_circulacao.md` (baseado no "Guia Completo de Circulação Teatral v2.0", 2025-10-04).
- **Escopo:** Fonte da verdade da circulação. Catálogo em [[fonte-al-repertorio]].
...
## Alimenta
- [[circulacao-teatral]] · [[fim]] · [[60-minutos-para-morrer]] · [[fabio-oliviere]]
